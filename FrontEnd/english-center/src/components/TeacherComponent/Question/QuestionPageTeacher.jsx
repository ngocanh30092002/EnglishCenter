...
const QuestionToeicPage = LazyLoading(() => import('../../AdminComponent/Question/Toeic/QuestionToeicPage'));
const QuestionNormalPage = LazyLoading(() => import('../../AdminComponent/Question/Normal/QuestionNormalPage'));

function QuestionPageTeacher() {
            ...
            <div className='flex-1 overflow-visible'>
                <Suspense fallback={<LoaderPage />}>
                    <Routes>
                        ...
                        <Route path='toeic/*' element={<QuestionToeicPage isTeacher={true} />} />
                    </Routes>
                </Suspense>
            </div>
        </div>
...
export default QuestionPageTeacher