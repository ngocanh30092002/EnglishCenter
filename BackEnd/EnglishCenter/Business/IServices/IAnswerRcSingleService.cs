...
{
    public interface IAnswerRcSingleService
    {
        ...
        public Task<Response> CreateAsync(AnswerRcSingleDto model);
        public Task<Response> UpdateAsync(long id, AnswerRcSingleDto model);
