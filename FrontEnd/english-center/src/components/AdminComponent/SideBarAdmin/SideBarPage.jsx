        ...
        <div className={`side-bar__wrapper 
            ...
            <SideBarContext.Provider value={{ isExpand, onSetExpand: setExpand }}>
                ...
                <ul className='side-bar__home'>
                    {adminUserComponents.map((item, index) => <SideBarItem key={index} item={item} isExpand={isExpand} onActive = {setActiveIndex} activeIndex = {activeIndex}/>)}
                </ul>

                <ul className='side-bar__study-info'>
                    {adminStudyComponents.map((item, index) => <SideBarItem key={index} item={item} isExpand={isExpand} onActive = {setActiveIndex} activeIndex = {activeIndex}/>)}
                </ul>
