...
{
    public interface IAnswerRcTripleService
    {
        ...
        public Task<Response> CreateAsync(AnswerRcTripleDto model);
        public Task<Response> UpdateAsync(long id, AnswerRcTripleDto model);
