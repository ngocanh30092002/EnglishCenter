...
{
    public interface ISubLcConService
    {
        ...
        public Task<Response> CreateAsync(SubLcConDto subModel);
        public Task<Response> UpdateAsync(long subId, SubLcConDto subModel);
