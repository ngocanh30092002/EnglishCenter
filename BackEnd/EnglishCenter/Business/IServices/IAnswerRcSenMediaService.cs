...
{
    public interface IAnswerRcSenMediaService
    {
        ...
        public Task<Response> CreateAsync(AnswerRcSenMediaDto model);
        public Task<Response> UpdateAsync(long id, AnswerRcSenMediaDto model);
