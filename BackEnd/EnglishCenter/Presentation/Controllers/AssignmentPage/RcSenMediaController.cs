...
{
    [Route("api/rc-sen-media")]
    [ApiController]
    public class RcSenMediaController : ControllerBase
    {
        private readonly IQuesRcSenMediaService _quesService;
        private readonly IAnswerRcSenMediaService _answerService;

        public RcSenMediaController(IQuesRcSenMediaService quesService, IAnswerRcSenMediaService answerService)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetQuesSenMediaAsync()
        {
        ...
        [HttpGet("{quesId}")]
        public async Task<IActionResult> GetQuesSenMediaAsync([FromRoute] long quesId)
        {
        ...
        public async Task<IActionResult> CreateAsync([FromForm] QuesRcSenMediaDto queModel)
        {
        ...
        [HttpPut("{quesId}")]
        [Authorize(Policy = GlobalVariable.ADMIN_TEACHER)]
        public async Task<IActionResult> UpdateAsync([FromRoute] long quesId, [FromForm] QuesRcSenMediaDto queModel)
        {
        ...
        [Authorize(Policy = GlobalVariable.ADMIN_TEACHER)]
        public async Task<IActionResult> ChangeQuesImageAsync([FromRoute] long quesId, IFormFile imageFile)
        {
        ...
        [Authorize(Policy = GlobalVariable.ADMIN_TEACHER)]
        public async Task<IActionResult> ChangeQuesAudioAsync([FromRoute] long quesId, IFormFile? audioFile)
        {
        ...
        [HttpPost("answers")]
        [Authorize(Policy = GlobalVariable.ADMIN_TEACHER)]
        public async Task<IActionResult> CreateAnswerAsync([FromForm] AnswerRcSenMediaDto model)
        {
        ...
        [Authorize(Policy = GlobalVariable.ADMIN_TEACHER)]
        public async Task<IActionResult> UpdateAnswerAsync([FromRoute] long answerId, [FromForm] AnswerRcSenMediaDto model)
        {
