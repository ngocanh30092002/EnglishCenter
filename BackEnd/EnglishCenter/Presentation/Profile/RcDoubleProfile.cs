...
{
    public class RcDoubleProfile : Profile
    {
        public RcDoubleProfile()
        {
            CreateMap<QuesRcDouble, QuesRcDoubleResDto>()
               ...
               .ForMember(des => des.Questions, opt => opt.MapFrom(src => src.SubRcDoubles));

            CreateMap<AnswerRcDouble, AnswerRcDoubleDto>()
            ...
            CreateMap<SubRcDoubleDto, SubRcDouble>()
            ...
            CreateMap<SubRcDouble, SubRcDoubleResDto>()
