...
{
    public interface ISubRcTripleService
    {
        ...
        public Task<Response> CreateAsync(SubRcTripleDto subModel);
        public Task<Response> UpdateAsync(long subId, SubRcTripleDto subModel);
