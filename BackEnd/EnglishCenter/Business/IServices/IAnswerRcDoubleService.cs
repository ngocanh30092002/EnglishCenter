...
{
    public interface IAnswerRcDoubleService
    {
        ...
        public Task<Response> CreateAsync(AnswerRcDoubleDto model);
        public Task<Response> UpdateAsync(long id, AnswerRcDoubleDto model);
