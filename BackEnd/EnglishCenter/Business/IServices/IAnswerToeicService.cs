...
{
    public interface IAnswerToeicService
    {
        ...
        public Task<Response> CreateAsync(AnswerToeicDto model);
        public Task<Response> UpdateAsync(long id, AnswerToeicDto model);
