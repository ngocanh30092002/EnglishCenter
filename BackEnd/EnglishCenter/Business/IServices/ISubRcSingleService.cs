...
{
    public interface ISubRcSingleService
    {
        ...
        public Task<Response> CreateAsync(SubRcSingleDto subModel);
        public Task<Response> UpdateAsync(long subId, SubRcSingleDto subModel);
